...
//    public final static String FILE_UPLOAD_DIC = "/www/wwwroot/MaterialX/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "/Users/liyaodong/Desktop/MaterialX-master/src/main/resources/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    //public final static String FILE_UPLOAD_DIC = "D:\\27690\\Documents\\MaterialX\\MaterialX\\src\\main\\resources\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
